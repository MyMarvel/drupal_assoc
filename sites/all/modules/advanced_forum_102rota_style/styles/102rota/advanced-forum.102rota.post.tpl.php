...
<div id="<?php print $post_id; ?>" class="<?php print $classes; ?>" <?php print $attributes; ?>>
  ...
  <div class="forum-post-wrapper">
    ...
    <div class="forum-post-panel-main clearfix">
      ...
      <div class="forum-post-content">
        <div class="author-name-for-mobile cufon"><?php print theme('username', array('account' => $account)); ?></div>
        <?php
  ...
  <div class="forum-post-footer clearfix">
    <div class="bottom-author-pane">
      <div class="forum-jump-links clearfix">
       <!-- <a href="#forum-topic-top" title="<?php print t('Jump to top of page'); ?>" class="af-button-small"><span><?php print t("Top"); ?></span></a> //Moved this at hook_comment_view function -->
      </div>
    </div>
    
    <div class="forum-bottom-date">
      <?php print $date ?>
    </div>
